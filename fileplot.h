...
inline int plot_ocs_histo(const symseq *x,                                      const time_t time1, const char *plottype, const char *filename, const char *comment,FILE *lptr){
...
inline int plot_dft_seq(const seqR1 *x, const long start, const long finish, const double mindB, const double maxdB, const char *filename, const char *comment){
...
inline int plot_R1_seq(const seqR1 *x, const long start, const long finish,               const double min, const double max, const double widthmm, const double heightmm, const char *filename, const char *comment){
 ...
 *-------------------------------------------------------------------------*/
inline void printof(FILE *fptr, const char *str){fprintf(stdout,"%s",str);fprintf(fptr,"%s",str);}
inline void printef(FILE *fptr, const char *str){fprintf(stderr,"%s",str);fprintf(fptr,"%s",str);}
