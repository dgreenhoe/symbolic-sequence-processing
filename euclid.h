...
inline double emetric(vectR2 p, vectR2 q){ return ae_metric(1.0,p,q); }
inline double emetric(vectR3 p, vectR3 q){ return ae_metric(1.0,p,q); }
inline double emetric(vectR6 p, vectR6 q){ return ae_metric(1.0,p,q); }
